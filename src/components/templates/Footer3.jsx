...
const Footer3 = () => {
  ...
  const [footer3, setFooter3] = useState(""); // Variable para almacenar el código HTML
      ...
      <div class="container mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="flex items-center justify-center">
          ...
          <a href="#" class="text-gray-400 hover:text-gray-200 mx-2">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path
                d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm3.678 7.068H8.322c-.52 0-.94.42-.94.94v8.184c0 .52.42.94.94.94h7.356c.52 0 .94-.42.94-.94v-8.184c0-.52-.42-.94-.94-.94zm-3.678 5.834c-.905 0-1.638-.733-1.638-1.638s.733-1.638 1.638-1.638 1.638.733 1.638 1.638-.733 1.638-1.638 1.638zm3.733 2.97h-1.287v-1.287h1.287v1.287z"
              ></path>
            </svg>
          </a>
        </div>
          ...
          <footer class="bg-slate-200 text-zinc-700 py-8">
            <div class="container mx-auto px-4">
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <h3 class="text-lg font-semibold mb-2">Otros enlaces</h3>
                  <ul class="space-y-2">
                    <li>
                      <a href="#" class="hover:text-gray-400">
                        Política de privacidad
